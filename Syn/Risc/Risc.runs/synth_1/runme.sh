...
HD_PWD='C:/Ain_shams/RiscV/Syn/Risc/Risc.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log riscv_processor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source riscv_processor.tcl
