package writeback_monitor_pkg;
    ...
    class writeback_monitor extends uvm_monitor;
        ...
        uvm_analysis_port #(writeback_item) mon_port;
        writeback_item mon_item, cloned_item;
        virtual writeback_interface vif;

        virtual function void build_phase (uvm_phase phase);
            super.build_phase(phase);
            mon_port = new("mon_port",this);
            mon_item = writeback_item::type_id::create("mon_item");
